...
import ro.ase.cts.seminar10.command.IncreaseLightIntensity;
...
System.out.println("------------------------------------------------");
		...
		CommandInterface increaseLightCommand=new IncreaseLightIntensity(bulb);
		RemoteControl remote=new RemoteControl(lightOnCommand, lightOffCommand, dimLightCommand, increaseLightCommand);
